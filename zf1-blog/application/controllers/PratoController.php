...
class PratoController extends Prato_Controller_Action {
    ...
    public function indexAction() {
        ...
        /* 	$tabela = new Application_Model_DbTable_Post();
          $posts = $tabela ->fetchAll(null, 'idpost');

          $this ->view ->posts = $posts; */

        /*  $con = Zend_Db_Table_Abstract::getDefaultAdapter();

          $listarPosts = $con ->select() ->from(array('post' => 'post'))
          ->join(array('categoria' => 'categoria'),
          'post.idcategoria = categoria.idcategoria');

          $this ->view ->posts = $listarPosts ->query() ->fetchAll(); */
    ...
    public function createAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($frm->isValid($params)) {
                ...
                $flashMessenger->addMessage("O prato foi cadastrado com sucesso");
    ...
    public function deleteAction() {
        ...
        $flashMessenger = $this->_helper->FlashMessenger;
        $flashMessenger->addMessage("Registro do prato apagado com sucesso");
    ...
    public function updateAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($frm->isValid($params)) {  //vai atribuir os valores para cada elemento e validar
                ...
                $flashMessenger = $this->_helper->FlashMessenger;
                $flashMessenger->addMessage("O prato foi atualizado com sucesso.");
